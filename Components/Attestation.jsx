                    ...
                    <div>
                      ...
                      {session?.user && (
                        <div className="bg-indigo-100 rounded-lg p-6 transition-all duration-300 hover:shadow-md">
                          ...
                          <button
                            className="w-full bg-red-500 text-indigo-900 px-6 py-2 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-50"
                            onClick={() => signOut()}
                          >
                            Sign out
                          </button>
